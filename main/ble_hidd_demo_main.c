...
#define BOOT_BUTTON_NUM_DOWN    4
#define BOOT_BUTTON_NUM_UP      5
...
void button_init_up(uint32_t button_num)
{
...
void button_init_down(uint32_t button_num)
{
    button_config_t btn_cfg = {
        .type = BUTTON_TYPE_GPIO,
        .gpio_button_config = {
...
void app_main(void)
{
    button_init_up(BOOT_BUTTON_NUM_UP);
    button_init_down(BOOT_BUTTON_NUM_DOWN);
